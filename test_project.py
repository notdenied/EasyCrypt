...
class TestAppApi(unittest.TestCase):
    ...
    def test_caesar(self):
        text = '''Возвратившись со смотра, Кутузов, сопутствуемый австрийским генералом, прошел в свой кабинет и, кликнув адъютанта, приказал подать себе некоторые бумаги, относившиеся до состояния приходивших войск, и письма, полученные от эрцгерцога Фердинанда, начальствовавшего передовою армией. Князь Андрей Болконский с требуемыми бумагами вошел в кабинет главнокомандующего. Перед разложенным на столе планом сидели Кутузов и австрийский член гофкригсрата.'''
        enc_text = Caesar.encode(text, rotate=10)
        self.assertTrue(Caesar.crack_by_frequency(
            enc_text, common_count=5) == text)
        self.assertTrue(Caesar.crack_by_enchant(enc_text, 'ru') == text)

    def test_steganography(self):
        Steganography.insert_text(
            'images/test_images/lk.png', 'I like Python!', 'images/test_images/lk_enc.png')
        Steganography.insert_text(
            'images/test_images/lk.jpg', 'I like Python!', 'images/test_images/lk_enc_jpg.png')
        # We couldn't use jpg for Steganography so easy because it uses complex compress algorithm and some data may be corrupted.
        Steganography.insert_text(
            'images/test_images/lk.bmp', 'I like Python!', 'images/test_images/lk_enc.bmp')
        self.assertTrue(Steganography.read_text(
            'images/test_images/lk_enc.png') == 'I like Python!' == Steganography.read_text(
            'images/test_images/lk_enc_jpg.png') == Steganography.read_text('images/test_images/lk_enc.bmp'))
